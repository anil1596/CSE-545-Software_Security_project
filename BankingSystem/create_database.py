...
customer = Customers()
employee = Employee()
customer.create_customer_id('rachel', "green",  "", "rachel",  "8894141486", "rachel@gmail.com", "password", "rachelssn", getdate(), 1)
customer.create_customer_id('monika', "geller",  "", "monika",  "8894141485", "monika@gmail.com", "password", "monikassn", getdate(), 1)
customer.create_customer_id('phoebe', "buffay",  "", "phoebe",  "8894141489", "phoebe@gmail.com", "password", "phoebessn", getdate(), 1)

employee.create_employee('ross', "geller",  "", "ross",  "6205709722", "ross@gmail.com", "password","gellerssn", getdate(), 1)
employee.create_employee('chandler', "bing",  "", "chandler",  "6205709723", "chandler@gmail.com", "password","bing1ssn", getdate(), 2)
employee.create_employee('joey', "tribbiani",  "", "joey",  "6205709721", "joey@gmail.com", "password","joey1ssn", getdate(), 3)